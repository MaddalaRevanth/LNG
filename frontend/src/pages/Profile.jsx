...
function Profile() {
  ...
  return (
    <div className='w-full h-[100vh] bg-slate-200 flex flex-col justify-center items-center gap-[20px]'>
      ...
      <div
        className='bg-white rounded-full border-4 border-[#333333] shadow-gray-400 shadow-lg relative'
      ...
      >
        ...
        <div className='absolute bottom-4 text-gray-700 right-4 w-[35px] h-[35px] rounded-full bg-[#333333] flex justify-center items-center shadow-gray-400 shadow-lg'>
      ...
      <form className='w-[95%] max-w-[500px] flex flex-col gap-[20px] items-center justify-center' onSubmit={handleProfile}>
        ...
        <input
          ...
          className='w-[90%] h-[50px] outline-none border-2 border-[#333333] px-[20px] py-[10px] bg-[white] rounded-lg shadow-gray-400 shadow-lg text-gray-700 text-[19px]'
        ...
        <input
          type="text"
          readOnly
          className='w-[90%] h-[50px] outline-none border-2 border-[#333333] px-[20px] py-[10px] bg-[white] rounded-lg shadow-gray-400 shadow-lg text-gray-400 text-[19px]'
