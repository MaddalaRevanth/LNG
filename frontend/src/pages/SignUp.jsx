  ...
  return (
    <div className="w-full h-[100vh] bg-slate-200 flex items-center justify-center">
      <div className="w-full max-w-[500px] h-[600px] bg-white rounded-lg shadow-gray-400 shadow-lg flex flex-col gap-[30px]">
        ...
        <div className="w-full h-[220px] bg-[#20c7ff] rounded-b-[30%] shadow-gray-400 shadow-lg flex flex-col items-center justify-center gap-2">
          <img
            src="/logo.jpg"
            alt="LNG Logo"
          ...
          <h1 className="text-white font-bold text-[24px] mt-2">
            Welcome to <span className="text-gray-800">LNG</span>
          </h1>
